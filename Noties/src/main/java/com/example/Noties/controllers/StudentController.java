...
public class StudentController {
    ...
    public String createStudent(@RequestParam("file1") MultipartFile file1, @RequestParam("file2") MultipartFile file2,
                             @RequestParam("file3") MultipartFile file3, Student student, Principal principal) throws IOException {
    ...
    public String editStudentSubmit(@PathVariable Long id, @RequestParam("file1") MultipartFile file1,
