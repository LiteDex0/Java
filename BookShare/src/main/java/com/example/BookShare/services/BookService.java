package com.example.BookShare.services;

import com.example.BookShare.models.User;
import com.example.BookShare.repositories.BookRepository;
import com.example.BookShare.models.Book;
import com.example.BookShare.models.Image;
import com.example.BookShare.repositories.UserRepository;
...
public class BookService {
    ...
    public void saveBook(Principal principal, Book book, MultipartFile file1, MultipartFile file2, MultipartFile file3) throws IOException {
        ...
        log.info("Сохранена новая книга,  {}; Автор: {}", book.getTitle(), book.getAuthor());
